...
const enDict = {
    ...
    privacyBodyAnalytics: 'Your photo is always processed on your device and never uploaded. This site uses an analytics provider that logs visits (including IP addresses) — enabled by the site owner. No photos are transmitted. For parents: no accounts or cookies from geez·art itself; the analytics provider may store its own identifier. Ask before sharing a real person\'s picture.',
    ready: 'Ready',
    rendering: 'Rendering…',
