...
export const STRINGS: { en: typeof enDict; am: Record<I18nKey, string> } = {
  ...
  am: {
    ...
    tooLarge: 'ፋይሉ ከ200 ሜባ ይበልጣል — ትንሽ ይሞክሩ።',
    buildFailed: 'ፋይሉን መስራት አልተቻለም — እንደገና ይሞክሩ።',
    buildLetterSetFailed: 'የፊደል ስብስብ መገንባት አልተቻለም — እንደገና ይሞክሩ።',
    play: 'ያጫውቱ',
    pause: 'ያቁሙ',
    downloadReplay: 'ያውርዱ',
    closeReplay: 'ይዝጉ',
